...
"}"));
        ...
        sizePolicy3.setHeightForWidth(box_arduino->sizePolicy().hasHeightForWidth());
        ...
        Button_light_shed->setFont(font1);
        ...
        Button_chandelier->setFont(font1);
        ...
        Button_light_door->setFont(font1);
